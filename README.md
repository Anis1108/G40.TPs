...
Quand un client se déconnecte, le serveur supprime ce client de la liste des clients connectés et envoie une notification aux autres clients pour les informer de cette déconnexion. La notification contient le nom du client qui s'est déconnecté.
